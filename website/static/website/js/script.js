$(document).ready(function(){
    ...
    if ($('.header-slide').length) {
        var bgs = $('.header-slide').data('images').split(',');

        $('.header-slide').backstretch(bgs, {
            fade: 850,
            duration: 4000
        });
    }
        ...
        marker:{
            ...
            options: {
             icon: new google.maps.MarkerImage(
               "/static/website/img/location.png",
    ...
    $('a[href="#location"]').on('shown.bs.tab', function(){
        var lat = $('#map-property').data('lat'),
            lng = $('#map-property').data('lng');
